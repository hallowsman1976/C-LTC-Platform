...
/* ============================================================
 * CG.2 (รายงานการเยี่ยมบ้านผู้ป่วยและผู้สูงอายุ) — ต้องตรงกับ ENUM_* ใน Setup.gs เป๊ะ
 * ============================================================ */
export const DEPENDENCY_GROUP_OPTIONS = ['1', '2', '3', '4'];
export const FAMILY_CAREGIVER_RELATION_OPTIONS = ['สามี/ภรรยา/บุตร', 'ญาติ', 'ผู้รับจ้าง', 'อื่นๆ'];
export const SYMPTOM_TREND_OPTIONS = ['คงที่', 'ดีขึ้น', 'แย่ลง'];
export const RECOMMENDATION_OPTIONS = ['อาหาร', 'ออกกำลัง', 'อารมณ์', 'อื่นๆ'];
...
const SYMPTOM_TREND_BADGE_CLASS = {
  'ดีขึ้น': 'bg-emerald-100 text-emerald-700',
  'คงที่': 'bg-amber-100 text-amber-700',
  'แย่ลง': 'bg-rose-100 text-rose-700'
};

/** @param {string} symptomTrend @return {string} */
export function symptomTrendBadgeClass(symptomTrend) {
  return SYMPTOM_TREND_BADGE_CLASS[symptomTrend] || 'bg-slate-100 text-slate-600';
}
