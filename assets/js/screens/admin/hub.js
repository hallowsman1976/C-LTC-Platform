...
const ADMIN_SECTIONS = [
  ...
  { href: '#/admin/assignments', title: 'มอบหมายทีมดูแล', desc: 'ดูว่าผู้ป่วยรายใดยังไม่มี CG/CM รับผิดชอบ และมอบหมายจากหน้าเดียว' },
  ...
  { href: '#/admin/patients-import', title: 'นำเข้าข้อมูลผู้ป่วย', desc: 'อัปโหลดไฟล์ CSV เพื่อเพิ่มผู้ป่วยหลายรายพร้อมกัน' },
