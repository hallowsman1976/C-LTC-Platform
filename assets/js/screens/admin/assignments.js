...
function summaryTile(label, value, valueClass) {
  return `
    <div class="flat-card animate-rise-in bg-white rounded-2xl p-3 text-center">
...
function mobileRowHtml(p, ctx) {
  return `
    <div class="flat-card bg-white rounded-2xl p-4 mb-3" data-patient-row="${escapeHtml(p.patientId)}">
